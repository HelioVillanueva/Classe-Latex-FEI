...
\setboolean{@twoside}{false} % mesmo que utilizado a opção twoside, elementos pre-textuais devem ser impressos apenas na frente (manter sempre false aqui).
\maketitle
\begin{folhaderosto}
...
\setboolean{@twoside}{false} % caso acima de 100 folhas, utilizar o twoside como opção da classe e true nesta função. Atentar para que a primeira página após o sumário comece sempre na frente. Dica: incluir ou excluir a dedicatória/epígrafe.
\chapter{LOREM IPSUM}
